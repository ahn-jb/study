...
<body>
	...
	<table border="0" align="center">
		<tr>
			<td colspan="15" align="right" style="padding: 5px 20px 10px;">
				<c:if test="${sessionScope.cookNo==null || sessionScope.cookNo==0 }">
					<a href="${path }/member/indexL.do">로그인</a>&nbsp;&nbsp;
					<a href="${path }/member/indexC.do">회원가입</a>
				</c:if> 
				<c:if test="${sessionScope.cookNo != null && sessionScope.cookNo > 0 }">
					${sessionScope.cookName } 님 환영합니다.
		            <a href="${path}/member/indexM.do">[회원정보 수정]</a>
		...
		<tr>
			...
			<td style="padding: 0px 20px;" id="member"><a href="${path }/member/index.do">회원관리</a></td>
			<td style="padding: 0px 20px;" id="memo"><a href="${path }/memo/index.do">메모장</a></td>
			<td style="padding: 0px 20px;" id="guestbook"><a href="${path }/guestbook/index.do">방명록</a></td>
			<td style="padding: 0px 20px;" id="survey"><a href="${path }/survey/index.do">설문조사</a></td>
			<td style="padding: 0px 20px;" id="survey2"><a href="${path }/survey/index2.do">설문지(종합)</a></td>
			<td style="padding: 0px 20px;" id="board"><a href="${path }/board/index.do">게시판</a></td>
			<td style="padding: 0px 20px;" id="product"><a href="${path }/product/index.do">Mall(상품관리)</a></td>
			<td style="padding: 0px 20px;" id="mall"><a	href="${path }/mall/index.do">Mall(쇼핑몰)</a></td>
			<td style="padding: 0px 20px;" id="chart"><a href="${path }/chart/index.do">Chart</a></td>
			<td style="padding: 0px 20px;" id="smtpEmail"><a href="${path }/email/index.do">Email</a></td>
<%-- 			<td style="padding: 0px 20px;" id="calculator"><a href="${path }/calculator/index.do">계산기</a></td> --%>
