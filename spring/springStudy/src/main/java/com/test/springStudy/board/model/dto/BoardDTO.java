...
public class BoardDTO {
	//field
			...
			public String toString() {
				return "BoardDTO [no=" + no + ", num=" + num + ", tbl=" + tbl + ", writer=" + writer + ", subject="
						+ subject + ", content=" + content + ", email=" + email + ", passwd=" + passwd + ", refNo="
						+ refNo + ", stepNo=" + stepNo + ", levelNo=" + levelNo + ", p_no=" + p_no + ", hit=" + hit
						+ ", ip=" + ip + ", memberNo=" + memberNo + ", noticeNo=" + noticeNo + ", secretGubun="
						+ secretGubun + ", regiDate=" + regiDate + ", p_no_result=" + p_no_result + ", answer_boolean="
						+ answer_boolean + ", noticeGubun=" + noticeGubun + ", child_counter=" + child_counter
						+ ", preNo=" + preNo + ", nextNo=" + nextNo + ", preSubject=" + preSubject + ", nextSubject="
						+ nextSubject + ", comment_no=" + comment_no + ", board_no=" + board_no + ", comment_writer="
						+ comment_writer + ", comment_content=" + comment_content + ", comment_passwd=" + comment_passwd
						+ ", comment_counter=" + comment_counter + ", tblName=" + tblName + "]";
			}
