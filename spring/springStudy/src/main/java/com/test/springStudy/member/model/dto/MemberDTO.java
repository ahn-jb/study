...
public class MemberDTO {
		...
		public String toString() {
			return "MemberDTO [no=" + no + ", id=" + id + ", pw=" + pw + ", name=" + name + ", gender=" + gender
					+ ", bornYear=" + bornYear + ", regidate=" + regidate + ", LoginCounter=" + LoginCounter
					+ ", grade=" + grade + ", ip=" + ip + ", postNum=" + postNum + ", street_addr=" + street_addr
					+ ", parcel_addr=" + parcel_addr + ", detail_addr=" + detail_addr + ", reference=" + reference
					+ ", bunryu=" + bunryu + ", subject=" + subject + ", content=" + content + ", rank=" + rank
					+ ", answer=" + answer + ", no_member=" + no_member + "]";
		}
