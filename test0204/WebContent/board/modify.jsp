...
<body>
	...
	<form name="writeForm" action="">
		...
		<table border="1" width ="600" align="center">
			<tr>
				<td>작성자:</td>
				<td><input type="text" name="writer" value="${dto.getWriter()}" style="width:40%;" ></td>
			</tr>
			<tr>
				<td>이메일:</td>
				<td><input type="text" name="email" value="${dto.getEmail()}" style="width:80%;"></td>
			</tr>
			<tr>
				<td>제목:</td>
				<td><input type="text" name="subject" value="${dto.getSubject()}" style="width:80%;"></td>
			</tr>
			<tr>
				<td>내용:</td>
				<td><textarea name="content" style="width:100%; height:100px;">${dto.getContent()}</textarea></td>
			</tr>
...
function save(){
	...
	document.writeForm.action ="${path}/board_servlet/modifyProc.do";
