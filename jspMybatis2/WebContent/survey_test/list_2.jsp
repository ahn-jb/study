...
<body>
	<form name="list2">
	<input type="text" id="answer_total" name="answer_total" value="">
...
<script type="text/javascript">
	function goSaveProc(){
		$("#answer_total").val($("#span_answer_total").text());
		var answer_total = $("#answer_total").val();
		if(answer_total == ''){
			alert('정답을 체크해 주세요.');
		}else if(confirm('제출 하시겠습니까?')){
			
			list2.method="post";
			list2.action="${path}/test_servlet/saveProc.do";
			list2.submit();
		}
	}
