...
import common.Util;
import model.dao.survey.SurveyDAO;
...
//			ArrayList<SurveyDTO> list = dao.getSelectSurvey(startRecord, lastRecord,list_gubun,search_option,search_data);
			ArrayList<SurveyDTO> list = dao.getSelectSurvey(startRecord, lastRecord,
