...
<%	String id = request.getParameter("id");
	...
	Member02DTO dto = dao.getSelectOne(id);
%>   
 ...
 function go(){
	if(	document.view.pw.value != document.view.password.value){
		...
		history.back();
	 		 ...
	 		 document.view.action='update02.jsp?id='+document.view.id.value;
 ...
 function remove(){
	 if(document.view.pw.value != document.view.password.value){
			...
			history.back();
	 		 ...
	 		 document.view.method='post';
	 		 document.view.action='delete02.jsp?id='+document.view.id.value+'&no='+document.view.no.value;
	 		 document.view.submit();
 	 }
 }
</script>